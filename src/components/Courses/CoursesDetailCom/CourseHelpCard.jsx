  ...
  return mentor ? (
    ...
    <div className='rounded-2xl border border-black/10 bg-white p-5 shadow-sm'>
      ...
      <div className='mt-4 flex items-end justify-between gap-3'>
        <button
          className='rounded-lg bg-[#9333ea] px-4 py-2 text-[13px] font-semibold text-white'
          onClick={() => setMentor(true)}
        >
          Open Mentor Chat
        </button>

        <img src='https://api.dicebear.com/7.x/adventurer/svg?seed=mentor' alt='mentor' className='h-16 w-16' />
      </div>
    </div>
  );
}
